...
--        } or
    ...
    results = util.me.byproduct() and {
      {type="item", name = util.me.lead_plate, amount=2, independent_probability=5/6},
      {type="item", name = "copper-ore", amount=1, independent_probability=1/3},
    } or {
    ...
    data:extend({
      {
        ...
        icons = {
          { icon = "__space-age__/graphics/icons/lithium-plate.png", icon_size = 64, tint = { 0.5, 0.3, 0.25 } },
        },
        group = "intermediate-products",
    ...
    data:extend({
      {
        ...
        normal = (util.k2() and {
          ...
          results = {
            { type = "item", name = "lead-ingot", amount = 2, independent_independent_probability = 5 / 6 },
            { type = "item", name = "copper-ore", amount = 1, independent_probability = 1 / 3 },
          },
        }),
        expensive = {
          ...
          results = {
            { type = "item", name = "lead-ingot", amount = 2, independent_probability = 5 / 6 },
            { type = "item", name = "copper-ore", amount = 2, independent_probability = 1 / 3 },
          },
        },
      },
    })
      ...
      data:extend({
        {
          ...
          icons = {
            ...
            { icon = "__base__/graphics/icons/iron-plate.png", icon_size = 64, scale = 0.25, shift = { 8, -6 } },
            {
              icon = "__bzlead__/graphics/icons/lead-plate.png",
              icon_size = 64,
              icon_mipmaps = 3,
        ...
        },
        {
          ...
          icons = {
            { icon = util.k2assets() .. "/icons/items-with-variations/ammo/pistol-ammo-1.png", icon_size = 64 },
            { icon = "__base__/graphics/icons/copper-plate.png", icon_size = 64, scale = 0.25, shift = { 8, -6 } },
            {
              icon = "__bzlead__/graphics/icons/lead-plate.png",
              icon_size = 64,
              icon_mipmaps = 3,
